...
def handle_resume_enhancement_with_rich_text():
    ...
    with tabs[0]:
        ...
        enhanced_summary = rich_text_editor(
            value=st.session_state.enhanced_resume["summary"] or original_summary,
            height=200,
            key="summary_editor"
        )
    ...
    with tabs[1]:
        ...
        enhanced_experience = rich_text_editor(
            value=st.session_state.enhanced_resume["experience"] or original_experience,
            height=300,
    ...
    with tabs[2]:
        ...
        enhanced_education = rich_text_editor(
            value=st.session_state.enhanced_resume["education"] or original_education,
            height=200,
    ...
    with tabs[3]:
        ...
        enhanced_skills = rich_text_editor(
            value=st.session_state.enhanced_resume["skills"] or original_skills,
            height=200,
            key="skills_editor"
        )
    ...
    with tabs[4]:
        ...
        enhanced_additional = rich_text_editor(
            value=st.session_state.enhanced_resume["additional"] or original_additional,
            height=300,
